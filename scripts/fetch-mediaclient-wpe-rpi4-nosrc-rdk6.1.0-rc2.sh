...
rm -rf rpi4_mediaclient_wpe_nosrc_rdk6.1.0-rc2
mkdir rpi4_mediaclient_wpe_nosrc_rdk6.1.0-rc2
cd rpi4_mediaclient_wpe_nosrc_rdk6.1.0-rc2
...
echo "RUN FOLLOWING TO PREPARE FOR BUILD: cd rpi4_mediaclient_wpe_nosrc_rdk6.1.0-rc2; source _build.sh"
