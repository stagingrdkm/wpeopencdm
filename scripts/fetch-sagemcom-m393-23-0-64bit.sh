...
# add patch in meta-rdk-sagemcom
(cd meta-rdk-sagemcom && patch -p1 < /home/ptrekels/64bit-stblinux.patch)
...
download_list=(
    ...
    "$TGZS_DIR/stblinux-5.4-1.10.tar.bz2#downloads/stblinux-5.4-1.10.tar.bz2"
...
cat <<EOF >> meta-rdk-sagemcom/meta-sagemcom-generic/recipes-bsp/broadcom-refsw/broadcom-refsw-driver%.bbappend 
...
#echo 'DISTRO_FEATURES_remove = "wlan_3_13"' >> conf/local.conf
