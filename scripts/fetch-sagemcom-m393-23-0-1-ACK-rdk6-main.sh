...
TARGET_DIR_SUFFIX="_23_0_1_ACK_RDK6MAIN"
#
...
repo init -u https://code.rdkcentral.com/r/rdk/yocto_oe/manifests/bcm-accel-manifests -b rdk6-main -m rdkv-broadcom-va.xml
