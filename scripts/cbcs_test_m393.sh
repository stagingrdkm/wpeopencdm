...
rm -rf cbcs_test_m393$TARGET_DIR_SUFFIX
mkdir cbcs_test_m393$TARGET_DIR_SUFFIX
cd cbcs_test_m393$TARGET_DIR_SUFFIX
...
echo "RUN FOLLOWING TO PREPARE FOR BUILD: cd cbcs_test_m393$TARGET_DIR_SUFFIX; source _build.sh"
