...
rm -rf 7218c_mediaclient_23_0_1_ACK$TARGET_DIR_SUFFIX
mkdir 7218c_mediaclient_23_0_1_ACK$TARGET_DIR_SUFFIX
cd 7218c_mediaclient_23_0_1_ACK$TARGET_DIR_SUFFIX
...
echo "RUN FOLLOWING TO PREPARE FOR BUILD: cd 7218c_mediaclient_23_0_1_ACK$TARGET_DIR_SUFFIX; source _build.sh"
