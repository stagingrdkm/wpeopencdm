...
TARGET_DIR_SUFFIX="_23_0_1_ACK_RDK61RC2"
#
...
repo init -u https://code.rdkcentral.com/r/rdk/yocto_oe/manifests/bcm-accel-manifests -b 6.1.0-rc2 -m rdkv-broadcom-va.xml
