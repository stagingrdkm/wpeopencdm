...
rm -rf rtd1319_reference_next$TARGET_DIR_SUFFIX
mkdir rtd1319_reference_next$TARGET_DIR_SUFFIX
cd rtd1319_reference_next$TARGET_DIR_SUFFIX
...
source meta-cmf-video-reference-next/setup-environment
EOF

echo "RUN FOLLOWING TO PREPARE FOR BUILD: cd rtd1319_reference_next$TARGET_DIR_SUFFIX; source _build.sh"
